    ...
    public partial class uctPromotion : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public bool checkPromotion(int iProduct_ID,decimal dPrice, DateTime dBeginDate)
        {
            ...
            try
            {
                ...
                int iRowCount=0;
                iRowCount = Common.ParseInt(clsSQL.ExecScalarStore("spPromo_checkPromotion", param));
                if (iRowCount>0)
                {
                    iValid =false ;
                }
        ...
        private void gvPromotion_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        if (e.RowHandle == Program.NEW_ROW && !checkPromotion(Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "Product_ID")), Convert.ToDecimal(gvPromotion.GetRowCellValue(e.RowHandle, "Price")), Convert.ToDateTime(gvPromotion.GetRowCellValue(e.RowHandle, "BeginDate"))))
                        {
                ...
                //////////else
                //////////{
                //////////    if (Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "PercentDiscount"))< 0 )
                //////////    {
                ...
                //////////else
                //////////{
                //////////    if (Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "Number_buy")) < 0)
                //////////    {
                ...
                //////////}
                //////////else {
                //////////    if (Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "Number_Promotions")) < 0)
                //////////    {
                ...
                if (gvPromotion.GetRowCellValue(e.RowHandle, "Form") == SettingCodeDB.TypePromotion_Discount)
                {
                    ...
                    else
                    {
                        ...
                        {
                            PercentDiscount = Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "PercentDiscount"));
                        }
                ...
                else if (gvPromotion.GetRowCellValue(e.RowHandle, "Form") == SettingCodeDB.TypePromotion_Product)
                {
                    ...
                    {
                        Number_buy222 = Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "Number_buy"));
                    }
                    int Number_Promotions222 = 0;
                    if (gvPromotion.GetRowCellValue(e.RowHandle, "Number_Promotions").ToString() != "")
                    {
                        Number_Promotions222 = Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "Number_Promotions"));
                    }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (gvPromotion.GetRowCellValue(e.RowHandle, "Number_buy").ToString() != "")
                            {
                                Number_buy333 = Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "Number_buy"));
                            }
                        ...
                        else
                        {
                            ...
                            if (gvPromotion.GetRowCellValue(e.RowHandle, "Number_Promotions").ToString() != "")
                            {
                                Number_Promotions333 = Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "Number_Promotions"));
                            }
                ...
                else if (gvPromotion.GetRowCellValue(e.RowHandle, "Form") == SettingCodeDB.TypePromotion_Product_Discount)
                {
                    ...
                    else
                    {
                        ...
                        if (gvPromotion.GetRowCellValue(e.RowHandle, "PercentDiscount").ToString() != "")
                        {
                            PercentDiscount333 = Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "PercentDiscount"));
                        }
                ...
                if (bValid )
                {
                    ...
                    if (e.RowHandle==Program.NEW_ROW )
                    {
                        ...
                        param.Add("@Product_ID", SqlDbType.Int, Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "Product_ID")));
                        int PercentDiscount222 = 0;
                        if (gvPromotion.GetRowCellValue(e.RowHandle, "PercentDiscount").ToString() != "")
                        {
                            PercentDiscount222 = Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "PercentDiscount"));
                        }
                    ...
                    else
                    {
                        ...
                        param.Add("@Form", SqlDbType.NVarChar, gvPromotion.GetRowCellValue(e.RowHandle, "Form").ToString());
                        param.Add("@Note", SqlDbType.NVarChar, gvPromotion.GetRowCellValue(e.RowHandle, "Note").ToString());
                        param.Add("@Promotion_ID", SqlDbType.Int, Common.ParseInt(gvPromotion.GetRowCellValue(e.RowHandle, "Promotion_ID")));
        ...
        private void btnGetData_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        param = new QryParam();
                        param.Add("@Company_ID", SqlDbType.Int, Common.ParseInt(cboCompany.EditValue));
            ...
            try
            {
                if (e.KeyCode == Keys.Delete && gvPromotion.State != DevExpress.XtraGrid.Views.Grid.GridState.Editing && gvPromotion.FocusedRowHandle >= 0)
                {
                    if (XtraMessageBox.Show("Bạn có chắc chắn muốn xóa??? " + Environment.NewLine + "Lưu ý: Khi bạn xóa, Các hóa đơn xuất sẽ không bị ảnh hưởng.", "KHUYEN MAI", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        clsSQL = new QryData(Program.config.ConnectionString);
                        param = new QryParam();
                        param.Add("@Promotion_ID", SqlDbType.Int, Common.ParseInt(gvPromotion.GetRowCellValue(gvPromotion.FocusedRowHandle, "Promotion_ID")));
        ...
        private void gvPromotion_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            try
            {
                ...
                if (e.Column.FieldName=="Product_ID")
                {
                    ...
                    {
                        col_KMPrice_Edit.Items.Add(Common.ParseInt(row[0]).ToString());
                    }
