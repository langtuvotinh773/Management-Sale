...
namespace Management.Commons
{
    public static class Common
    {
        ...
        public static long iPermission { get; set; }
        ...
        public static String ConvertStrMoney(object obj)
        {
            try
            {
                if (IsNullOrEmpty(obj))
                    return "0";
                double price = double.Parse(obj.ToString());
                string text = price.ToString("#,###");
                if (text == "")
                {
                    text = "0";
                }
                //.ToString("N1"); // N3 for 3 digits , etc
                return text;
            }
            catch (Exception ex)
            {
        ...
        /// <returns></returns>
        public static decimal ParseDecimal(object obj,int lenght)
        {
            try
            {
                ...
                if (IsNullOrEmpty(obj))
                    return 0;
                string str = Convert.ToDecimal(obj).ToString("#,##0"); 
...
"ÝỲỴỶỸ"
        ...
        public static int getPermissionType(string userName, string pass)
        {
            int iResult = 0;
            try
            {
                ...
                param = new QryParam();
                param.Add("@UserName", SqlDbType.VarChar, userName);
        ...
        public static void updatePermissionType(string userName, string pass, int PermissionType)
        {
            int iResult = 0;
            try
            {
                ...
                param.Add("@UserName", SqlDbType.VarChar, userName);
                param.Add("@PassWord", SqlDbType.VarChar,pass);
                param.Add("@PermissionType", SqlDbType.TinyInt, PermissionType);
