...
GO
/****** Object:  StoredProcedure [dbo].[spReport_InventoryUpdate_All]    Script Date: 11/22/2013 20:23:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER Proc [dbo].[spReport_InventoryUpdate_All] 
	@BeginDate Datetime,
	@EndDate Datetime
AS
BEGIN
	...
	SElect pro.Company_ID, pro.ProductName, odd.Price_Import,
			...
			Sum(odd.TienNhapHang) as Amount
