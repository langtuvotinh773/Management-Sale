        ...
        private void btnSort_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (DataRow dtRow in dtOrder.Rows)
                {
                    ...
                    col6 = Common.ConvertStrMoney(dtRow["TienLoiThucTe"].ToString());
                    col7 = Common.ConvertStrMoney(dtRow["TongTienDaNhapHang"].ToString());
                    ...
                    tableResult.Rows.Add(col0, col1, "", "", col4, col5, col6, col7, Common.ConvertStrMoney(col7));
                }
